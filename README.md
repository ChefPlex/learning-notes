...
| [Lessons from Putting AI Into a Company](lessons-from-putting-ai-into-a-company.md) | What nobody tells you at the start. Six lessons on AI adoption and governance: why you are never introducing AI but getting control of something already running, how fear and enthusiasm both distort the map, why the headcount objection is rational and what actually answers it, showing people it helps rather than mandating use, how a human review gate rots into a rubber stamp and how to calibrate friction to consequence, and why buying paid accounts is a data-loss control rather than an enablement budget. Companion piece: the [frameworks](https://github.com/ChefPlex/ai-automations/tree/main/frameworks) in ai-automations. |
